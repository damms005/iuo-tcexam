...
switch ($menu_mode) {
    ...
    case 'extendtime':{
            ...
            SET testuser_creation_time=\'' . F_getTestNewStartTime($testuser_id, isset($_POST['relative_to_current_time']), (isset($_POST['add_mins']) && is_numeric($_POST['add_mins'])) ? $_POST['add_mins'] : null) . '\'
			WHERE testuser_id=' . $testuser_id . '';
