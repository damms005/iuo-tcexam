...
if (isset($_REQUEST['startdate'])) {
    ...
    $startdate = "";//leave it empty, so that result will be generated for this test even if no date set - otherwise tcexam wrongly shows blank screen even when test result exists (very bad when printing result for test taken sometimes ago)
...
if (isset($_REQUEST['enddate'])) {
    ...
    $enddate = "";//leave it empty, so that result will be generated for this test even if no date set - otherwise tcexam wrongly shows blank screen even when test result exists (very bad when printing result for test taken sometimes ago)
