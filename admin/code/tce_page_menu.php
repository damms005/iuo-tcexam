...
$menu['tce_menu_tests.php']['sub'] = array(
    ...
    'tce_import_omr_answers.php' => array('link' => 'tce_import_omr_answers_legacy.php', 'title' => $l['t_omr_answers_importer'], 'name' => $l['w_import_omr_answers'], 'level' => K_AUTH_ADMIN_OMR_IMPORT, 'key' => '', 'enabled' => true),
    ...
    'tce_import_omr_answers_bulk_smart.php' => array('link' => 'tce_import_omr_answers_bulk_smart.php', 'title' => 'OMR Smart Importer', 'name' => 'OMR Smart Importer', 'level' => K_AUTH_ADMIN_OMR_IMPORT, 'key' => '', 'enabled' => true),
