        ...
        switch ($qdata[0]) {
            ...
            case 'S':{ // SUBJECT
                    ...
                    if ($current_module_id == 0) {
                        exit("(1) no module in entry: [$qdata_]");
                        return;
                    }
                    if (!isset($qdata[2]) or empty($qdata[2])) {
                        break;
            ...
            case 'Q':{ // QUESTION
                    ...
                    if (($current_module_id == 0) or ($current_subject_id == 0)) {
                        exit("(2) no moduel($current_module_id) or subject_id($current_subject_id) [$qdata_]");
                        return;
                    }
                    if (!isset($qdata[5])) {
                        break;
            ...
            case 'A':{ // ANSWER
                    ...
                    if (($current_module_id == 0) or ($current_subject_id == 0) or ($current_question_id == 0)) {
                        exit("(3) no module_id($current_module_id) or subject($current_subject_id) or question_id($current_question_id) [$qdata_]");
                        return;
                    }
                    if (!isset($qdata[4])) {
                        break;
