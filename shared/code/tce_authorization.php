...
<script>
    //change all checkboxes to pretty
    /*
    ...
    $(function(){
        ...
        $("input[type='radio']").each(function( index , elmnt ){
            ...
            if( closest_label ) {
                ...
                $(elmnt).wrap('<div class="pretty p-icon p-round p-pulse" />');
                $( elmnt ).closest('div').append( ` <div class="state p-success-o> <i class="icon mdi mdi-check"></i> <label> ${$( closest_label ).text()} </label> </div> `);
